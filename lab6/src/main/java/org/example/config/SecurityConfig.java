...
public class SecurityConfig {
    ...
    public AuthenticationProvider authenticationProvider() {
        DaoAuthenticationProvider authProvider = new DaoAuthenticationProvider(); // ← Убрали аргумент
        authProvider.setUserDetailsService(customUserDetailsService); // ← Отдельно устанавливаем UserDetailsService
        authProvider.setPasswordEncoder(passwordEncoder()); // ← Отдельно устанавливаем PasswordEncoder
        return authProvider;
    }
